...
},{"./alert":"alert.js"}],"map.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap() {
  ...
  var locationsCoordinates = locations.map(function (location) {
  ...
  locationsCoordinates.forEach(function (locationCoordinates, i) {
    var marker = L.marker(locationCoordinates).addTo(map);
    marker.bindPopup("Day ".concat(locations[i].day, " - ").concat(locations[i].description)).openPopup();
  });
  var bounds = L.latLngBounds(locationsCoordinates);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch("http://127.0.0.1:3000/api/v1/users/updateMyPassword", {
            method: "PATCH",
            headers: {
...
var userPasswordFormEl = document.querySelector(".form-user-settings");
if (userDataFormEl) {
...
if (userPasswordFormEl) {
  userPasswordFormEl.addEventListener("submit", function (e) {
    e.preventDefault();
...
if (formEl) {
  var emailInputEl = formEl.querySelector("#email");
  var passwordInputEl = formEl.querySelector("#password");
