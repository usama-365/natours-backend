...
const tourSchema = new mongoose.Schema({
	name: {
		...
		// validate: [validator.isAlpha, 'Tour name can only contain
		// characters']
	},
	slug: String,
	duration: {
...
//     const tourGuidesPromises = this.guides.map(async guideID => await
// User.findById(guideID)); this.guides = await
// Promise.all(tourGuidesPromises); next(); });
